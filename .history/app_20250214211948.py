...
def verify_faiss_index():
    ...
    if os.path.exists(FAISS_INDEX_PATH):
        try:
            ...
            st.sidebar.success("Index FAISS chargé avec succès !")
            return index
...
st.sidebar.markdown("[Accéder à l’application !](https://infinity-ia.streamlit.app/)")
...
if choice == "Accueil":
    ...
    if os.path.exists(IMG_PATH):
        ...
        st.error(f"Le fichier image est introuvable : {IMG_PATH}")
